...
#  }
    ...
    def system_collateralization_ratio():
        return total_peth_in_system * (tag / self.RAY) / self.global_dai_available() 
    ...
    def report(self):
        ...
        print("global CDP collateralization ratio: ", round(self.system_collateralization_ratio(cup_id)))
